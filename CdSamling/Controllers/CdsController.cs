...
namespace CdSamling.Controllers
{
    public class CdsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CdName,Artist,NrTracks,ReleaseYear")] Cd cd)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CdName,Artist,NrTracks,ReleaseYear")] Cd cd)
        {
            if (id != cd.Id)
            {
                return NotFound();
