...
namespace CdSamling.Controllers
{
    public class CdsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CdName,NrTracks,ReleaseYear,ArtistId")] Cd cd)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CdName,NrTracks,ReleaseYear,ArtistId")] Cd cd)
        {
            if (id != cd.Id)
            {
                return NotFound();
